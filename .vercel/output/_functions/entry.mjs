...
var middlewareSecret = "1792c0fd-5327-4b2f-a4f2-383911cebd5c";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": "https://sakrt.in",
			"SSR": true
		}, { _: "/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://sakrt.in",
			"SSR": true
		}, { _: "/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product/biodegradable-water-bottles",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/biodegradable-water-bottles\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "biodegradable-water-bottles",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/compostable-product/biodegradable-water-bottles/index.astro",
			"pathname": "/compostable-product/biodegradable-water-bottles",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product/carry-bags",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/carry-bags\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/compostable-product/carry-bags/index.astro",
			"pathname": "/compostable-product/carry-bags",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product/compostable-films",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/compostable-films\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "compostable-films",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/compostable-product/compostable-films/index.astro",
			"pathname": "/compostable-product/compostable-films",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product/compostable-grow-bags",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/compostable-grow-bags\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "compostable-grow-bags",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/compostable-product/compostable-grow-bags/index.astro",
			"pathname": "/compostable-product/compostable-grow-bags",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product/compostable-pouches",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/compostable-pouches\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "compostable-pouches",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/compostable-product/compostable-pouches/index.astro",
			"pathname": "/compostable-product/compostable-pouches",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product/food-packaging-boxes",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/food-packaging-boxes\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "food-packaging-boxes",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/compostable-product/food-packaging-boxes/index.astro",
			"pathname": "/compostable-product/food-packaging-boxes",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/compostable-product",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/compostable-product\\/?$",
			"segments": [[{
				"content": "compostable-product",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/compostable-product/index.astro",
			"pathname": "/compostable-product",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/contact-us/index.astro",
			"pathname": "/contact-us",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/media/index.astro",
			"pathname": "/media",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/our-certifications",
			"isIndex": true,
			"type": "page",
			"pattern": "^\\/our-certifications\\/?$",
			"segments": [[{
			...
			"params": [],
			"component": "src/pages/our-certifications/index.astro",
			"pathname": "/our-certifications",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_Dw2lrqKy.mjs");
var _page1 = () => import("./chunks/index_CUbQ6-Gt.mjs");
var _page2 = () => import("./chunks/enquiry_CiWuhhEt.mjs");
var _page3 = () => import("./chunks/_slug__DLTB2Y2h.mjs");
var _page4 = () => import("./chunks/index_BpzQpobr.mjs");
var _page5 = () => import("./chunks/index_D3m5llr8.mjs");
var _page6 = () => import("./chunks/index_Ci1cTOaW.mjs");
var _page7 = () => import("./chunks/index_BxDWFMcv.mjs");
var _page8 = () => import("./chunks/index_CI9Orxce.mjs");
var _page9 = () => import("./chunks/index_CYi66zsg.mjs");
var _page10 = () => import("./chunks/index_w9lUF2Ge.mjs");
var _page11 = () => import("./chunks/index_BCCxIl6F.mjs");
var _page12 = () => import("./chunks/index_DWgqwU9G.mjs");
var _page13 = () => import("./chunks/index_M8ljXRfb.mjs");
var _page14 = () => import("./chunks/index_DYTkgYmy.mjs");
var _page15 = () => import("./chunks/index_DSmUjnqO.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/about/index.astro", _page1],
	["src/pages/api/enquiry.ts", _page2],
	["src/pages/blog/[slug].astro", _page3],
	["src/pages/blog/index.astro", _page4],
	["src/pages/compostable-product/biodegradable-water-bottles/index.astro", _page5],
	["src/pages/compostable-product/carry-bags/index.astro", _page6],
	["src/pages/compostable-product/compostable-films/index.astro", _page7],
	["src/pages/compostable-product/compostable-grow-bags/index.astro", _page8],
	["src/pages/compostable-product/compostable-pouches/index.astro", _page9],
	["src/pages/compostable-product/food-packaging-boxes/index.astro", _page10],
	["src/pages/compostable-product/index.astro", _page11],
	["src/pages/contact-us/index.astro", _page12],
	["src/pages/media/index.astro", _page13],
	["src/pages/our-certifications/index.astro", _page14],
	["src/pages/index.astro", _page15]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/","cacheDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/node_modules/.astro/","outDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/dist/","srcDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/","publicDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/public/","buildClientDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/dist/client/","buildServerDir":"file:///Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"},{"type":"external","src":"_astro/index.DVvcf-HZ.css"}],"routeData":{"route":"/about","isIndex":true,"type":"page","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/about/index.astro","pathname":"/about","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/enquiry","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/enquiry\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"enquiry","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/enquiry.ts","pathname":"/api/enquiry","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/blog/category/[category]/[slug]","isIndex":false,"type":"page","pattern":"^\\/blog\\/category\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"category","dynamic":false,"spread":false}],[{"content":"category","dynamic":true,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["category","slug"],"component":"src/pages/blog/category/[category]/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/blog/category/[category]","isIndex":false,"type":"page","pattern":"^\\/blog\\/category\\/([^/]+?)\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"category","dynamic":false,"spread":false}],[{"content":"category","dynamic":true,"spread":false}]],"params":["category"],"component":"src/pages/blog/category/[category].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":".single-post-container[data-astro-cid-zg7dkzxc]{max-width:800px;margin:0 auto;padding:10rem 2rem 4rem;font-family:Helvetica Neue,Arial,sans-serif}.post-header[data-astro-cid-zg7dkzxc]{text-align:center;margin-bottom:3rem}.post-meta[data-astro-cid-zg7dkzxc]{justify-content:center;align-items:center;gap:1rem;margin-bottom:1.5rem;display:flex}.category-badge[data-astro-cid-zg7dkzxc]{text-transform:uppercase;letter-spacing:.05em;border:1px solid #e0e0e0;border-radius:20px;padding:.25rem .75rem;font-size:.75rem;display:inline-block}.date[data-astro-cid-zg7dkzxc]{color:#666;font-size:.875rem}.post-title[data-astro-cid-zg7dkzxc]{color:#111;font-size:2.5rem;line-height:1.2}.hero-image[data-astro-cid-zg7dkzxc]{border-radius:8px;width:100%;margin-bottom:3rem;overflow:hidden}.hero-image[data-astro-cid-zg7dkzxc] img[data-astro-cid-zg7dkzxc]{object-fit:cover;width:100%;height:auto}.back-link[data-astro-cid-zg7dkzxc]{text-align:center;border-top:1px solid #eee;margin-top:4rem;padding-top:2rem}.back-link[data-astro-cid-zg7dkzxc] a[data-astro-cid-zg7dkzxc]{color:#1b3d2f;font-weight:700;text-decoration:none;transition:color .2s}.back-link[data-astro-cid-zg7dkzxc] a[data-astro-cid-zg7dkzxc]:hover{color:#a3d200}.wp-content{color:#333;font-size:1.1rem;line-height:1.8}.wp-content h2,.wp-content h3{color:#1b3d2f;margin-top:2.5rem;margin-bottom:1rem}.wp-content p{margin-bottom:1.5rem}.wp-content img{border-radius:8px;max-width:100%;height:auto;margin:2rem 0}.wp-content details,.wp-content .schema-faq-section{background-color:#f9f9f9;border:1px solid #eaeaea;border-radius:8px;margin-bottom:1rem;overflow:hidden}.wp-content summary,.wp-content .schema-faq-question{color:#1b3d2f;cursor:pointer;justify-content:space-between;align-items:center;margin-bottom:0;padding:1.25rem 1.5rem;font-size:1.1rem;font-weight:700;list-style:none;transition:background-color .2s;display:flex}.wp-content summary:after,.wp-content .schema-faq-question:after{content:\"+\";color:#1b3d2f;font-size:1.5rem;font-weight:300;line-height:1;transition:transform .3s}.wp-content details[open] summary:after,.wp-content .schema-faq-question.is-open:after{content:\"−\";transform:rotate(180deg)}.wp-content summary:hover,.wp-content .schema-faq-question:hover{background-color:#f0f0f0}.wp-content summary::-webkit-details-marker{display:none}.wp-content .schema-faq-answer{color:#555;margin-bottom:0;padding:0 1.5rem 1.25rem;font-size:1rem;display:none}.wp-content .schema-faq-answer.is-open{display:block}.wp-content details p{color:#555;margin-bottom:0;padding:0 1.5rem 1.25rem;font-size:1rem}\n"}],"routeData":{"route":"/blog/[slug]","isIndex":false,"type":"page","pattern":"^\\/blog\\/([^/]+?)\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/blog/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"external","src":"_astro/index.DX8m2YTr.css"}],"routeData":{"route":"/blog","isIndex":true,"type":"page","pattern":"^\\/blog\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blog/index.astro","pathname":"/blog","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":".faq-container[data-astro-cid-jxqay6yy]{max-width:900px;margin:0 auto;padding:2rem 1.5rem 6rem;font-family:system-ui,-apple-system,sans-serif}.faq-title[data-astro-cid-jxqay6yy]{color:#0b2218;margin-bottom:2rem;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(1.5rem,3vw,2rem);font-weight:600}.faq-list[data-astro-cid-jxqay6yy]{border-top:1px solid #e2e8f0;flex-direction:column;display:flex}.faq-item[data-astro-cid-jxqay6yy]{border-bottom:1px solid #e2e8f0}.faq-item[data-astro-cid-jxqay6yy]::details-content{transition:height .3s,opacity .3s}.faq-question[data-astro-cid-jxqay6yy]{cursor:pointer;color:#1e293b;justify-content:space-between;align-items:center;padding:1.5rem 0;font-size:1rem;font-weight:500;list-style:none;transition:color .2s;display:flex}.faq-question[data-astro-cid-jxqay6yy]::-webkit-details-marker{display:none}.faq-question[data-astro-cid-jxqay6yy]:hover{color:#0b2218;text-decoration:underline}.question-text[data-astro-cid-jxqay6yy]{align-items:flex-start;gap:.75rem;display:flex}.question-text[data-astro-cid-jxqay6yy] strong[data-astro-cid-jxqay6yy]{font-weight:600}.faq-icon[data-astro-cid-jxqay6yy]{color:#64748b;justify-content:center;align-items:center;transition:transform .3s;display:flex}details[data-astro-cid-jxqay6yy][open] .faq-icon[data-astro-cid-jxqay6yy]{transform:rotate(180deg)}.faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:0fr;transition:grid-template-rows .3s ease-out;display:grid}details[data-astro-cid-jxqay6yy][open] .faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:1fr}.faq-answer-inner[data-astro-cid-jxqay6yy]{overflow:hidden}.faq-answer[data-astro-cid-jxqay6yy] p[data-astro-cid-jxqay6yy]{color:#475569;margin:0;padding-bottom:1.5rem;padding-left:1.85rem;font-size:.95rem;line-height:1.6}\n.inquiry-card[data-astro-cid-5yt3isc2]{background-color:#0d3d26;border-radius:20px;padding:3rem 4rem}.inquiry-title[data-astro-cid-5yt3isc2]{font-family:var(--font-serif);color:#fff;text-align:center;margin:0 0 2rem;font-size:1.7rem;font-weight:400}.inquiry-form[data-astro-cid-5yt3isc2]{grid-template-columns:1fr 1fr;gap:1.5rem;display:grid}.full-width[data-astro-cid-5yt3isc2]{grid-column:1/-1}.input-group[data-astro-cid-5yt3isc2],.number-wrapper[data-astro-cid-5yt3isc2]{width:100%;position:relative}.no-spin[data-astro-cid-5yt3isc2]::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.no-spin[data-astro-cid-5yt3isc2]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.no-spin[data-astro-cid-5yt3isc2]{-moz-appearance:textfield;padding-right:2.5rem}.spin-arrows[data-astro-cid-5yt3isc2]{flex-direction:column;justify-content:center;gap:4px;display:flex;position:absolute;top:0;bottom:0;right:.5rem}.spin-arrows[data-astro-cid-5yt3isc2] button[data-astro-cid-5yt3isc2]{color:#bef264;cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;height:12px;padding:0;display:flex}.spin-arrows[data-astro-cid-5yt3isc2] button[data-astro-cid-5yt3isc2] svg[data-astro-cid-5yt3isc2]{width:16px;height:16px;transition:transform .1s}.spin-arrows[data-astro-cid-5yt3isc2] button[data-astro-cid-5yt3isc2]:hover svg[data-astro-cid-5yt3isc2]{transform:scale(1.2)}.form-input[data-astro-cid-5yt3isc2],.form-select[data-astro-cid-5yt3isc2]{color:#fff;box-sizing:border-box;background-color:#ffffff0a;border:1px solid #ffffff26;border-radius:8px;outline:none;width:100%;padding:.85rem 1rem;font-size:.875rem;transition:border-color .2s}.form-input[data-astro-cid-5yt3isc2]::placeholder{color:#8da397}.form-input[data-astro-cid-5yt3isc2]:focus,.form-select[data-astro-cid-5yt3isc2]:focus{border-color:#a3e635}.form-select[data-astro-cid-5yt3isc2]{appearance:none;color:#8da397;cursor:pointer}.select-arrow[data-astro-cid-5yt3isc2]{color:#8da397;pointer-events:none;width:16px;height:16px;position:absolute;top:50%;right:14px;transform:translateY(-50%)}.submit-btn[data-astro-cid-5yt3isc2]{color:#0e2d1f;letter-spacing:.08em;cursor:pointer;background-color:#bef264;border:none;border-radius:8px;width:100%;margin-top:.35rem;padding:1rem;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;font-size:.75rem;font-weight:700;transition:background-color .2s}.submit-btn[data-astro-cid-5yt3isc2]:hover{background-color:#a3e635}@media (width<=768px){.inquiry-form[data-astro-cid-5yt3isc2]{grid-template-columns:1fr}.inquiry-card[data-astro-cid-5yt3isc2]{border-radius:16px;padding:1.5rem 1.25rem}.inquiry-title[data-astro-cid-5yt3isc2]{margin-bottom:1.5rem;font-size:1.35rem}}\n"},{"type":"external","src":"_astro/index.B-VnIfF_.css"}],"routeData":{"route":"/compostable-product/biodegradable-water-bottles","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/biodegradable-water-bottles\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"biodegradable-water-bottles","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/biodegradable-water-bottles/index.astro","pathname":"/compostable-product/biodegradable-water-bottles","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".category-grid-container[data-astro-cid-3tt2kbh7]{justify-content:center;max-width:1340px;margin:0 auto;padding:4rem 1.5rem 6rem;display:flex}.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(1,1fr);gap:3rem;width:100%;max-width:1200px;display:grid}@media (width>=600px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(2,1fr)}}@media (width>=1024px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(4,1fr);gap:4rem 2rem}}.product-card[data-astro-cid-3tt2kbh7]{background:#fff;border-radius:12px;flex-direction:column;align-items:center;transition:transform .3s,box-shadow .3s;display:flex;overflow:hidden}.product-card[data-astro-cid-3tt2kbh7]:hover{transform:translateY(-5px);box-shadow:0 12px 30px #0000000d}.image-wrapper[data-astro-cid-3tt2kbh7]{aspect-ratio:1;box-sizing:border-box;background-color:#f7f8f6;justify-content:center;align-items:center;width:100%;padding:1.5rem;display:flex;overflow:hidden}.image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{object-fit:contain;mix-blend-mode:multiply;max-width:100%;max-height:100%;transition:transform .4s}.product-card[data-astro-cid-3tt2kbh7]:hover .image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{transform:scale(1.05)}.product-info[data-astro-cid-3tt2kbh7]{text-align:center;flex-direction:column;align-items:center;gap:1.25rem;padding:1.5rem 1rem;display:flex}.product-name[data-astro-cid-3tt2kbh7]{color:#0b2218;margin:0;font-family:system-ui,-apple-system,sans-serif;font-size:.95rem;font-weight:700;line-height:1.3}.view-details-btn[data-astro-cid-3tt2kbh7]{color:#fff;letter-spacing:.5px;background-color:#3b5f4c;border-radius:30px;padding:.6rem 1.5rem;font-family:system-ui,-apple-system,sans-serif;font-size:.8rem;font-weight:600;text-decoration:none;transition:background-color .2s,transform .2s;display:inline-block}.view-details-btn[data-astro-cid-3tt2kbh7]:hover{background-color:#0b2218}\n"},{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":".faq-container[data-astro-cid-jxqay6yy]{max-width:900px;margin:0 auto;padding:2rem 1.5rem 6rem;font-family:system-ui,-apple-system,sans-serif}.faq-title[data-astro-cid-jxqay6yy]{color:#0b2218;margin-bottom:2rem;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(1.5rem,3vw,2rem);font-weight:600}.faq-list[data-astro-cid-jxqay6yy]{border-top:1px solid #e2e8f0;flex-direction:column;display:flex}.faq-item[data-astro-cid-jxqay6yy]{border-bottom:1px solid #e2e8f0}.faq-item[data-astro-cid-jxqay6yy]::details-content{transition:height .3s,opacity .3s}.faq-question[data-astro-cid-jxqay6yy]{cursor:pointer;color:#1e293b;justify-content:space-between;align-items:center;padding:1.5rem 0;font-size:1rem;font-weight:500;list-style:none;transition:color .2s;display:flex}.faq-question[data-astro-cid-jxqay6yy]::-webkit-details-marker{display:none}.faq-question[data-astro-cid-jxqay6yy]:hover{color:#0b2218;text-decoration:underline}.question-text[data-astro-cid-jxqay6yy]{align-items:flex-start;gap:.75rem;display:flex}.question-text[data-astro-cid-jxqay6yy] strong[data-astro-cid-jxqay6yy]{font-weight:600}.faq-icon[data-astro-cid-jxqay6yy]{color:#64748b;justify-content:center;align-items:center;transition:transform .3s;display:flex}details[data-astro-cid-jxqay6yy][open] .faq-icon[data-astro-cid-jxqay6yy]{transform:rotate(180deg)}.faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:0fr;transition:grid-template-rows .3s ease-out;display:grid}details[data-astro-cid-jxqay6yy][open] .faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:1fr}.faq-answer-inner[data-astro-cid-jxqay6yy]{overflow:hidden}.faq-answer[data-astro-cid-jxqay6yy] p[data-astro-cid-jxqay6yy]{color:#475569;margin:0;padding-bottom:1.5rem;padding-left:1.85rem;font-size:.95rem;line-height:1.6}\n"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"},{"type":"inline","content":".category-page[data-astro-cid-pniadgnr]{background-color:#f3f4f1;min-height:100vh}.category-header[data-astro-cid-pniadgnr]{text-align:center;background:linear-gradient(#e6e9e4 0%,#f3f4f1 100%);padding:10rem 1.5rem 4rem}.category-title[data-astro-cid-pniadgnr]{font-family:var(--font-serif);color:#0d3d26;margin:0;font-size:clamp(2.5rem,5vw,2.98rem);font-weight:400}\n"}],"routeData":{"route":"/compostable-product/carry-bags","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/carry-bags\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"carry-bags","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/carry-bags/index.astro","pathname":"/compostable-product/carry-bags","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".category-grid-container[data-astro-cid-3tt2kbh7]{justify-content:center;max-width:1340px;margin:0 auto;padding:4rem 1.5rem 6rem;display:flex}.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(1,1fr);gap:3rem;width:100%;max-width:1200px;display:grid}@media (width>=600px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(2,1fr)}}@media (width>=1024px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(4,1fr);gap:4rem 2rem}}.product-card[data-astro-cid-3tt2kbh7]{background:#fff;border-radius:12px;flex-direction:column;align-items:center;transition:transform .3s,box-shadow .3s;display:flex;overflow:hidden}.product-card[data-astro-cid-3tt2kbh7]:hover{transform:translateY(-5px);box-shadow:0 12px 30px #0000000d}.image-wrapper[data-astro-cid-3tt2kbh7]{aspect-ratio:1;box-sizing:border-box;background-color:#f7f8f6;justify-content:center;align-items:center;width:100%;padding:1.5rem;display:flex;overflow:hidden}.image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{object-fit:contain;mix-blend-mode:multiply;max-width:100%;max-height:100%;transition:transform .4s}.product-card[data-astro-cid-3tt2kbh7]:hover .image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{transform:scale(1.05)}.product-info[data-astro-cid-3tt2kbh7]{text-align:center;flex-direction:column;align-items:center;gap:1.25rem;padding:1.5rem 1rem;display:flex}.product-name[data-astro-cid-3tt2kbh7]{color:#0b2218;margin:0;font-family:system-ui,-apple-system,sans-serif;font-size:.95rem;font-weight:700;line-height:1.3}.view-details-btn[data-astro-cid-3tt2kbh7]{color:#fff;letter-spacing:.5px;background-color:#3b5f4c;border-radius:30px;padding:.6rem 1.5rem;font-family:system-ui,-apple-system,sans-serif;font-size:.8rem;font-weight:600;text-decoration:none;transition:background-color .2s,transform .2s;display:inline-block}.view-details-btn[data-astro-cid-3tt2kbh7]:hover{background-color:#0b2218}\n"},{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":".faq-container[data-astro-cid-jxqay6yy]{max-width:900px;margin:0 auto;padding:2rem 1.5rem 6rem;font-family:system-ui,-apple-system,sans-serif}.faq-title[data-astro-cid-jxqay6yy]{color:#0b2218;margin-bottom:2rem;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(1.5rem,3vw,2rem);font-weight:600}.faq-list[data-astro-cid-jxqay6yy]{border-top:1px solid #e2e8f0;flex-direction:column;display:flex}.faq-item[data-astro-cid-jxqay6yy]{border-bottom:1px solid #e2e8f0}.faq-item[data-astro-cid-jxqay6yy]::details-content{transition:height .3s,opacity .3s}.faq-question[data-astro-cid-jxqay6yy]{cursor:pointer;color:#1e293b;justify-content:space-between;align-items:center;padding:1.5rem 0;font-size:1rem;font-weight:500;list-style:none;transition:color .2s;display:flex}.faq-question[data-astro-cid-jxqay6yy]::-webkit-details-marker{display:none}.faq-question[data-astro-cid-jxqay6yy]:hover{color:#0b2218;text-decoration:underline}.question-text[data-astro-cid-jxqay6yy]{align-items:flex-start;gap:.75rem;display:flex}.question-text[data-astro-cid-jxqay6yy] strong[data-astro-cid-jxqay6yy]{font-weight:600}.faq-icon[data-astro-cid-jxqay6yy]{color:#64748b;justify-content:center;align-items:center;transition:transform .3s;display:flex}details[data-astro-cid-jxqay6yy][open] .faq-icon[data-astro-cid-jxqay6yy]{transform:rotate(180deg)}.faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:0fr;transition:grid-template-rows .3s ease-out;display:grid}details[data-astro-cid-jxqay6yy][open] .faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:1fr}.faq-answer-inner[data-astro-cid-jxqay6yy]{overflow:hidden}.faq-answer[data-astro-cid-jxqay6yy] p[data-astro-cid-jxqay6yy]{color:#475569;margin:0;padding-bottom:1.5rem;padding-left:1.85rem;font-size:.95rem;line-height:1.6}\n"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"},{"type":"inline","content":".category-page[data-astro-cid-kwkeuoq5]{background-color:#f3f4f1;min-height:100vh}.category-header[data-astro-cid-kwkeuoq5]{text-align:center;background:linear-gradient(#e6e9e4 0%,#f3f4f1 100%);padding:10rem 1.5rem 4rem}.category-title[data-astro-cid-kwkeuoq5]{font-family:var(--font-serif);color:#0d3d26;margin:0;font-size:clamp(2.5rem,5vw,2.98rem);font-weight:400}\n"}],"routeData":{"route":"/compostable-product/compostable-films","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/compostable-films\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"compostable-films","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/compostable-films/index.astro","pathname":"/compostable-product/compostable-films","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"external","src":"_astro/index.sO1LLjiA.css"},{"type":"inline","content":".inquiry-card[data-astro-cid-5yt3isc2]{background-color:#0d3d26;border-radius:20px;padding:3rem 4rem}.inquiry-title[data-astro-cid-5yt3isc2]{font-family:var(--font-serif);color:#fff;text-align:center;margin:0 0 2rem;font-size:1.7rem;font-weight:400}.inquiry-form[data-astro-cid-5yt3isc2]{grid-template-columns:1fr 1fr;gap:1.5rem;display:grid}.full-width[data-astro-cid-5yt3isc2]{grid-column:1/-1}.input-group[data-astro-cid-5yt3isc2],.number-wrapper[data-astro-cid-5yt3isc2]{width:100%;position:relative}.no-spin[data-astro-cid-5yt3isc2]::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.no-spin[data-astro-cid-5yt3isc2]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.no-spin[data-astro-cid-5yt3isc2]{-moz-appearance:textfield;padding-right:2.5rem}.spin-arrows[data-astro-cid-5yt3isc2]{flex-direction:column;justify-content:center;gap:4px;display:flex;position:absolute;top:0;bottom:0;right:.5rem}.spin-arrows[data-astro-cid-5yt3isc2] button[data-astro-cid-5yt3isc2]{color:#bef264;cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;height:12px;padding:0;display:flex}.spin-arrows[data-astro-cid-5yt3isc2] button[data-astro-cid-5yt3isc2] svg[data-astro-cid-5yt3isc2]{width:16px;height:16px;transition:transform .1s}.spin-arrows[data-astro-cid-5yt3isc2] button[data-astro-cid-5yt3isc2]:hover svg[data-astro-cid-5yt3isc2]{transform:scale(1.2)}.form-input[data-astro-cid-5yt3isc2],.form-select[data-astro-cid-5yt3isc2]{color:#fff;box-sizing:border-box;background-color:#ffffff0a;border:1px solid #ffffff26;border-radius:8px;outline:none;width:100%;padding:.85rem 1rem;font-size:.875rem;transition:border-color .2s}.form-input[data-astro-cid-5yt3isc2]::placeholder{color:#8da397}.form-input[data-astro-cid-5yt3isc2]:focus,.form-select[data-astro-cid-5yt3isc2]:focus{border-color:#a3e635}.form-select[data-astro-cid-5yt3isc2]{appearance:none;color:#8da397;cursor:pointer}.select-arrow[data-astro-cid-5yt3isc2]{color:#8da397;pointer-events:none;width:16px;height:16px;position:absolute;top:50%;right:14px;transform:translateY(-50%)}.submit-btn[data-astro-cid-5yt3isc2]{color:#0e2d1f;letter-spacing:.08em;cursor:pointer;background-color:#bef264;border:none;border-radius:8px;width:100%;margin-top:.35rem;padding:1rem;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;font-size:.75rem;font-weight:700;transition:background-color .2s}.submit-btn[data-astro-cid-5yt3isc2]:hover{background-color:#a3e635}@media (width<=768px){.inquiry-form[data-astro-cid-5yt3isc2]{grid-template-columns:1fr}.inquiry-card[data-astro-cid-5yt3isc2]{border-radius:16px;padding:1.5rem 1.25rem}.inquiry-title[data-astro-cid-5yt3isc2]{margin-bottom:1.5rem;font-size:1.35rem}}\n"}],"routeData":{"route":"/compostable-product/compostable-grow-bags","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/compostable-grow-bags\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"compostable-grow-bags","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/compostable-grow-bags/index.astro","pathname":"/compostable-product/compostable-grow-bags","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".category-grid-container[data-astro-cid-3tt2kbh7]{justify-content:center;max-width:1340px;margin:0 auto;padding:4rem 1.5rem 6rem;display:flex}.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(1,1fr);gap:3rem;width:100%;max-width:1200px;display:grid}@media (width>=600px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(2,1fr)}}@media (width>=1024px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(4,1fr);gap:4rem 2rem}}.product-card[data-astro-cid-3tt2kbh7]{background:#fff;border-radius:12px;flex-direction:column;align-items:center;transition:transform .3s,box-shadow .3s;display:flex;overflow:hidden}.product-card[data-astro-cid-3tt2kbh7]:hover{transform:translateY(-5px);box-shadow:0 12px 30px #0000000d}.image-wrapper[data-astro-cid-3tt2kbh7]{aspect-ratio:1;box-sizing:border-box;background-color:#f7f8f6;justify-content:center;align-items:center;width:100%;padding:1.5rem;display:flex;overflow:hidden}.image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{object-fit:contain;mix-blend-mode:multiply;max-width:100%;max-height:100%;transition:transform .4s}.product-card[data-astro-cid-3tt2kbh7]:hover .image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{transform:scale(1.05)}.product-info[data-astro-cid-3tt2kbh7]{text-align:center;flex-direction:column;align-items:center;gap:1.25rem;padding:1.5rem 1rem;display:flex}.product-name[data-astro-cid-3tt2kbh7]{color:#0b2218;margin:0;font-family:system-ui,-apple-system,sans-serif;font-size:.95rem;font-weight:700;line-height:1.3}.view-details-btn[data-astro-cid-3tt2kbh7]{color:#fff;letter-spacing:.5px;background-color:#3b5f4c;border-radius:30px;padding:.6rem 1.5rem;font-family:system-ui,-apple-system,sans-serif;font-size:.8rem;font-weight:600;text-decoration:none;transition:background-color .2s,transform .2s;display:inline-block}.view-details-btn[data-astro-cid-3tt2kbh7]:hover{background-color:#0b2218}\n"},{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":".faq-container[data-astro-cid-jxqay6yy]{max-width:900px;margin:0 auto;padding:2rem 1.5rem 6rem;font-family:system-ui,-apple-system,sans-serif}.faq-title[data-astro-cid-jxqay6yy]{color:#0b2218;margin-bottom:2rem;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(1.5rem,3vw,2rem);font-weight:600}.faq-list[data-astro-cid-jxqay6yy]{border-top:1px solid #e2e8f0;flex-direction:column;display:flex}.faq-item[data-astro-cid-jxqay6yy]{border-bottom:1px solid #e2e8f0}.faq-item[data-astro-cid-jxqay6yy]::details-content{transition:height .3s,opacity .3s}.faq-question[data-astro-cid-jxqay6yy]{cursor:pointer;color:#1e293b;justify-content:space-between;align-items:center;padding:1.5rem 0;font-size:1rem;font-weight:500;list-style:none;transition:color .2s;display:flex}.faq-question[data-astro-cid-jxqay6yy]::-webkit-details-marker{display:none}.faq-question[data-astro-cid-jxqay6yy]:hover{color:#0b2218;text-decoration:underline}.question-text[data-astro-cid-jxqay6yy]{align-items:flex-start;gap:.75rem;display:flex}.question-text[data-astro-cid-jxqay6yy] strong[data-astro-cid-jxqay6yy]{font-weight:600}.faq-icon[data-astro-cid-jxqay6yy]{color:#64748b;justify-content:center;align-items:center;transition:transform .3s;display:flex}details[data-astro-cid-jxqay6yy][open] .faq-icon[data-astro-cid-jxqay6yy]{transform:rotate(180deg)}.faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:0fr;transition:grid-template-rows .3s ease-out;display:grid}details[data-astro-cid-jxqay6yy][open] .faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:1fr}.faq-answer-inner[data-astro-cid-jxqay6yy]{overflow:hidden}.faq-answer[data-astro-cid-jxqay6yy] p[data-astro-cid-jxqay6yy]{color:#475569;margin:0;padding-bottom:1.5rem;padding-left:1.85rem;font-size:.95rem;line-height:1.6}\n"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"},{"type":"inline","content":".category-page[data-astro-cid-244vxjgk]{background-color:#f3f4f1;min-height:100vh}.category-header[data-astro-cid-244vxjgk]{text-align:center;background:linear-gradient(#e6e9e4 0%,#f3f4f1 100%);padding:10rem 1.5rem 4rem}.category-title[data-astro-cid-244vxjgk]{font-family:var(--font-serif);color:#0d3d26;margin:0;font-size:clamp(2.5rem,5vw,2.98rem);font-weight:400}\n"}],"routeData":{"route":"/compostable-product/compostable-pouches","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/compostable-pouches\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"compostable-pouches","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/compostable-pouches/index.astro","pathname":"/compostable-product/compostable-pouches","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".category-grid-container[data-astro-cid-3tt2kbh7]{justify-content:center;max-width:1340px;margin:0 auto;padding:4rem 1.5rem 6rem;display:flex}.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(1,1fr);gap:3rem;width:100%;max-width:1200px;display:grid}@media (width>=600px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(2,1fr)}}@media (width>=1024px){.category-grid[data-astro-cid-3tt2kbh7]{grid-template-columns:repeat(4,1fr);gap:4rem 2rem}}.product-card[data-astro-cid-3tt2kbh7]{background:#fff;border-radius:12px;flex-direction:column;align-items:center;transition:transform .3s,box-shadow .3s;display:flex;overflow:hidden}.product-card[data-astro-cid-3tt2kbh7]:hover{transform:translateY(-5px);box-shadow:0 12px 30px #0000000d}.image-wrapper[data-astro-cid-3tt2kbh7]{aspect-ratio:1;box-sizing:border-box;background-color:#f7f8f6;justify-content:center;align-items:center;width:100%;padding:1.5rem;display:flex;overflow:hidden}.image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{object-fit:contain;mix-blend-mode:multiply;max-width:100%;max-height:100%;transition:transform .4s}.product-card[data-astro-cid-3tt2kbh7]:hover .image-wrapper[data-astro-cid-3tt2kbh7] img[data-astro-cid-3tt2kbh7]{transform:scale(1.05)}.product-info[data-astro-cid-3tt2kbh7]{text-align:center;flex-direction:column;align-items:center;gap:1.25rem;padding:1.5rem 1rem;display:flex}.product-name[data-astro-cid-3tt2kbh7]{color:#0b2218;margin:0;font-family:system-ui,-apple-system,sans-serif;font-size:.95rem;font-weight:700;line-height:1.3}.view-details-btn[data-astro-cid-3tt2kbh7]{color:#fff;letter-spacing:.5px;background-color:#3b5f4c;border-radius:30px;padding:.6rem 1.5rem;font-family:system-ui,-apple-system,sans-serif;font-size:.8rem;font-weight:600;text-decoration:none;transition:background-color .2s,transform .2s;display:inline-block}.view-details-btn[data-astro-cid-3tt2kbh7]:hover{background-color:#0b2218}\n"},{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":".faq-container[data-astro-cid-jxqay6yy]{max-width:900px;margin:0 auto;padding:2rem 1.5rem 6rem;font-family:system-ui,-apple-system,sans-serif}.faq-title[data-astro-cid-jxqay6yy]{color:#0b2218;margin-bottom:2rem;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(1.5rem,3vw,2rem);font-weight:600}.faq-list[data-astro-cid-jxqay6yy]{border-top:1px solid #e2e8f0;flex-direction:column;display:flex}.faq-item[data-astro-cid-jxqay6yy]{border-bottom:1px solid #e2e8f0}.faq-item[data-astro-cid-jxqay6yy]::details-content{transition:height .3s,opacity .3s}.faq-question[data-astro-cid-jxqay6yy]{cursor:pointer;color:#1e293b;justify-content:space-between;align-items:center;padding:1.5rem 0;font-size:1rem;font-weight:500;list-style:none;transition:color .2s;display:flex}.faq-question[data-astro-cid-jxqay6yy]::-webkit-details-marker{display:none}.faq-question[data-astro-cid-jxqay6yy]:hover{color:#0b2218;text-decoration:underline}.question-text[data-astro-cid-jxqay6yy]{align-items:flex-start;gap:.75rem;display:flex}.question-text[data-astro-cid-jxqay6yy] strong[data-astro-cid-jxqay6yy]{font-weight:600}.faq-icon[data-astro-cid-jxqay6yy]{color:#64748b;justify-content:center;align-items:center;transition:transform .3s;display:flex}details[data-astro-cid-jxqay6yy][open] .faq-icon[data-astro-cid-jxqay6yy]{transform:rotate(180deg)}.faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:0fr;transition:grid-template-rows .3s ease-out;display:grid}details[data-astro-cid-jxqay6yy][open] .faq-answer[data-astro-cid-jxqay6yy]{grid-template-rows:1fr}.faq-answer-inner[data-astro-cid-jxqay6yy]{overflow:hidden}.faq-answer[data-astro-cid-jxqay6yy] p[data-astro-cid-jxqay6yy]{color:#475569;margin:0;padding-bottom:1.5rem;padding-left:1.85rem;font-size:.95rem;line-height:1.6}\n"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"},{"type":"inline","content":".category-page[data-astro-cid-jucld3rl]{background-color:#f3f4f1;min-height:100vh}.category-header[data-astro-cid-jucld3rl]{text-align:center;background:linear-gradient(#e6e9e4 0%,#f3f4f1 100%);padding:10rem 1.5rem 4rem}.category-title[data-astro-cid-jucld3rl]{font-family:var(--font-serif);color:#0d3d26;margin:0;font-size:clamp(2.5rem,5vw,2.98rem);font-weight:400}\n"}],"routeData":{"route":"/compostable-product/food-packaging-boxes","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/food-packaging-boxes\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"food-packaging-boxes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/food-packaging-boxes/index.astro","pathname":"/compostable-product/food-packaging-boxes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/compostable-product/[category]/[slug]","isIndex":false,"type":"page","pattern":"^\\/compostable-product\\/([^/]+?)\\/([^/]+?)\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}],[{"content":"category","dynamic":true,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["category","slug"],"component":"src/pages/compostable-product/[category]/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"},{"type":"external","src":"_astro/index.BCUfuMVB.css"}],"routeData":{"route":"/compostable-product","isIndex":true,"type":"page","pattern":"^\\/compostable-product\\/?$","segments":[[{"content":"compostable-product","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/compostable-product/index.astro","pathname":"/compostable-product","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"external","src":"_astro/index.UfiF2PzJ.css"}],"routeData":{"route":"/contact-us","isIndex":true,"type":"page","pattern":"^\\/contact-us\\/?$","segments":[[{"content":"contact-us","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact-us/index.astro","pathname":"/contact-us","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"external","src":"_astro/index.I7dOifJl.css"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"}],"routeData":{"route":"/media","isIndex":true,"type":"page","pattern":"^\\/media\\/?$","segments":[[{"content":"media","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/media/index.astro","pathname":"/media","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"external","src":"_astro/index.CF2MhEUD.css"}],"routeData":{"route":"/our-certifications","isIndex":true,"type":"page","pattern":"^\\/our-certifications\\/?$","segments":[[{"content":"our-certifications","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/our-certifications/index.astro","pathname":"/our-certifications","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html.lenis,html.lenis body{height:auto}.lenis:not(.lenis-autoToggle).lenis-stopped{overflow:clip}.lenis [data-lenis-prevent],.lenis [data-lenis-prevent-wheel],.lenis [data-lenis-prevent-touch],.lenis [data-lenis-prevent-vertical],.lenis [data-lenis-prevent-horizontal]{overscroll-behavior:contain}.lenis.lenis-smooth iframe{pointer-events:none}.lenis.lenis-autoToggle{transition-behavior:allow-discrete;transition-property:overflow;transition-duration:1ms}\n"},{"type":"external","src":"_astro/Layout.B5dwR-gy.css"},{"type":"external","src":"_astro/index.Ivpvoqw8.css"},{"type":"inline","content":"@import \"https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..700;1,6..96,400..700&family=Space+Mono:wght@400;700&display=swap\";:root{--accent-lime:#b5e800}.cta-section[data-astro-cid-ro2uulzk]{box-sizing:border-box;justify-content:center;padding:10px 24px 100px;display:flex;position:relative}.cta-container[data-astro-cid-ro2uulzk]{width:100%;max-width:960px}.cta-card[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;background-color:#0d3d26;border-radius:10px;flex-direction:column;align-items:center;padding:32px 20px;display:flex;position:relative;overflow:hidden}.cta-subtitle[data-astro-cid-ro2uulzk]{letter-spacing:3px;color:var(--accent-lime);text-transform:uppercase;margin-bottom:12px;font-family:Space Mono,monospace;font-size:11px}.cta-title[data-astro-cid-ro2uulzk]{font-family:var(--font-serif);color:#fff;margin:0 0 16px;font-size:clamp(1.8rem,3.5vw,2.72rem);font-weight:400;line-height:1.08}.cta-description[data-astro-cid-ro2uulzk]{color:var(--color-border-subtle);letter-spacing:.2px;max-width:480px;margin:0 0 24px;font-family:Space Mono,monospace;font-size:14px;line-height:1.6}.cta-buttons[data-astro-cid-ro2uulzk]{flex-wrap:wrap;justify-content:center;gap:16px;display:flex}.btn-primary[data-astro-cid-ro2uulzk]{background-color:var(--accent-lime);color:var(--color-forest-dark);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-primary[data-astro-cid-ro2uulzk]:hover{background-color:#c4f514;transform:translateY(-2px)scale(1.06)}.btn-secondary[data-astro-cid-ro2uulzk]{color:var(--color-bg-card);font-family:var(--font-sans,system-ui, -apple-system, sans-serif);backdrop-filter:blur(8px);background-color:#ffffff2e;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;text-decoration:none;transition:transform .3s cubic-bezier(.16,1,.3,1),background-color .3s;display:inline-block}.btn-secondary[data-astro-cid-ro2uulzk]:hover{background-color:#ffffff47;transform:translateY(-2px)scale(1.03)}@media (width<=768px){.cta-card[data-astro-cid-ro2uulzk]{border-radius:10px;padding:24px 16px}.cta-buttons[data-astro-cid-ro2uulzk]{flex-direction:column;width:100%;max-width:280px}.btn-primary[data-astro-cid-ro2uulzk],.btn-secondary[data-astro-cid-ro2uulzk]{text-align:center;box-sizing:border-box;width:100%}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://sakrt.in","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/category/[category].astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/category/[category]/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/[category]/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/about/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/biodegradable-water-bottles/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/carry-bags/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/compostable-films/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/compostable-grow-bags/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/compostable-pouches/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/food-packaging-boxes/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/compostable-product/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/contact-us/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/media/index.astro",{"propagation":"none","containsHead":true}],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/our-certifications/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BE8SdC_I.mjs","\u0000virtual:astro:page:src/pages/blog/category/[category]@_@astro":"chunks/_category__C9aFSIK-.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:page:src/pages/blog/category/[category]/[slug]@_@astro":"chunks/_slug__D6z2Bp6v.mjs","\u0000virtual:astro:page:src/pages/compostable-product/[category]/[slug]@_@astro":"chunks/_slug__D7socHDk.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/blog/[slug]@_@astro":"chunks/_slug__DLTB2Y2h.mjs","\u0000virtual:astro:page:src/pages/api/enquiry@_@ts":"chunks/enquiry_CiWuhhEt.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_Dw2lrqKy.mjs","\u0000virtual:astro:page:src/pages/compostable-product/index@_@astro":"chunks/index_BCCxIl6F.mjs","\u0000virtual:astro:page:src/pages/blog/index@_@astro":"chunks/index_BpzQpobr.mjs","\u0000virtual:astro:page:src/pages/compostable-product/compostable-films/index@_@astro":"chunks/index_BxDWFMcv.mjs","\u0000virtual:astro:page:src/pages/compostable-product/compostable-grow-bags/index@_@astro":"chunks/index_CI9Orxce.mjs","\u0000virtual:astro:page:src/pages/about/index@_@astro":"chunks/index_CUbQ6-Gt.mjs","\u0000virtual:astro:page:src/pages/compostable-product/compostable-pouches/index@_@astro":"chunks/index_CYi66zsg.mjs","\u0000virtual:astro:page:src/pages/compostable-product/carry-bags/index@_@astro":"chunks/index_Ci1cTOaW.mjs","\u0000virtual:astro:page:src/pages/compostable-product/biodegradable-water-bottles/index@_@astro":"chunks/index_D3m5llr8.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DSmUjnqO.mjs","\u0000virtual:astro:page:src/pages/contact-us/index@_@astro":"chunks/index_DWgqwU9G.mjs","\u0000virtual:astro:page:src/pages/our-certifications/index@_@astro":"chunks/index_DYTkgYmy.mjs","\u0000virtual:astro:page:src/pages/media/index@_@astro":"chunks/index_M8ljXRfb.mjs","\u0000virtual:astro:page:src/pages/compostable-product/food-packaging-boxes/index@_@astro":"chunks/index_w9lUF2Ge.mjs","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_DObHJDIj.mjs","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Product/AllProductsGrid.astro?astro&type=script&index=0&lang.ts":"_astro/AllProductsGrid.astro_astro_type_script_index_0_lang.BTBZP8wC.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Our-Certifications/CertificatePreviewModal.astro?astro&type=script&index=0&lang.ts":"_astro/CertificatePreviewModal.astro_astro_type_script_index_0_lang.DAJXNVb9.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Ecosystem.astro?astro&type=script&index=0&lang.ts":"_astro/Ecosystem.astro_astro_type_script_index_0_lang.CmhvWy1N.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/EnquiryForm.astro?astro&type=script&index=0&lang.ts":"_astro/EnquiryForm.astro_astro_type_script_index_0_lang.DHBxw-ih.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Foundation.astro?astro&type=script&index=0&lang.ts":"_astro/Foundation.astro_astro_type_script_index_0_lang.CD6ZWPSR.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Header.astro?astro&type=script&index=0&lang.ts":"_astro/Header.astro_astro_type_script_index_0_lang.BGx4SmYy.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Hero.astro?astro&type=script&index=0&lang.ts":"_astro/Hero.astro_astro_type_script_index_0_lang.auXYiWtI.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/ContactUs/InquiryForm.astro?astro&type=script&index=0&lang.ts":"_astro/InquiryForm.astro_astro_type_script_index_0_lang.DBn0B60w.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Media/MediaHero.astro?astro&type=script&index=0&lang.ts":"_astro/MediaHero.astro_astro_type_script_index_0_lang.C0_aZUj5.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Mission.astro?astro&type=script&index=0&lang.ts":"_astro/Mission.astro_astro_type_script_index_0_lang._jLufRtE.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Media/RecognitionCard.astro?astro&type=script&index=0&lang.ts":"_astro/RecognitionCard.astro_astro_type_script_index_0_lang.CRcaAOdt.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/category/[category]/[slug].astro?astro&type=script&index=0&lang.ts":"_astro/_slug_.astro_astro_type_script_index_0_lang.B8MzO6px.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/[slug].astro?astro&type=script&index=0&lang.ts":"_astro/_slug_.astro_astro_type_script_index_0_lang.NxuYN-mF.js","/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/About/about.astro?astro&type=script&index=0&lang.ts":"_astro/about.astro_astro_type_script_index_0_lang.BrmEM1_R.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Product/AllProductsGrid.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`productGrid`),t=document.getElementById(`toggleGridBtn`);if(!e||!t)return;let n=e.querySelectorAll(`.product-card`),r=!1;function i(){let e=window.innerWidth;return e<=480?5:e<=900?9:12}function a(){let e=i();n.forEach((t,n)=>{r||n<e?t.classList.remove(`hidden`):t.classList.add(`hidden`)}),t.innerHTML=r?`VIEW LESS <span class=\"arrow\">↑</span>`:`VIEW MORE <span class=\"arrow\">↓</span>`,n.length<=e?t.style.display=`none`:t.style.display=`inline-block`}a(),t.addEventListener(`click`,()=>{r=!r,a(),r||e.scrollIntoView({behavior:`smooth`,block:`start`})}),window.addEventListener(`resize`,()=>{r||a()})}document.addEventListener(`DOMContentLoaded`,e),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Our-Certifications/CertificatePreviewModal.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`cert-preview-modal`),t=document.getElementById(`close-modal-btn`),n=document.getElementById(`modal-body`),r=document.querySelectorAll(`.cert-preview-trigger`);!e||!t||!n||(r.forEach(t=>{t.addEventListener(`click`,t=>{t.preventDefault();let r=t.currentTarget,i=r.getAttribute(`data-cert-url`),a=r.getAttribute(`data-cert-type`);i&&(a===`pdf`?n.innerHTML=`<iframe src=\"${i}#toolbar=0&navpanes=0&scrollbar=0&view=FitH\" title=\"Certificate Preview\"></iframe>`:n.innerHTML=`<img src=\"${i}\" alt=\"Certificate Preview\" loading=\"lazy\" />`,e.showModal())})}),t.addEventListener(`click`,()=>{e.close(),n.innerHTML=``}),e.addEventListener(`click`,t=>{let r=e.getBoundingClientRect();(t.clientX<r.left||t.clientX>r.right||t.clientY<r.top||t.clientY>r.bottom)&&(e.close(),n.innerHTML=``)}))}e(),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Ecosystem.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`ecosystem-section`),t=document.getElementById(`interactive-glow`),n=document.querySelectorAll(`[data-card]`);!e||n.length===0||(t&&e.addEventListener(`mousemove`,n=>{let r=e.getBoundingClientRect();t.style.left=`${n.clientX-r.left}px`,t.style.top=`${n.clientY-r.top}px`}),n.forEach(e=>{e.addEventListener(`mouseenter`,()=>{n.forEach(e=>e.classList.remove(`active-card`)),e.classList.add(`active-card`)})}))}e(),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/EnquiryForm.astro?astro&type=script&index=0&lang.ts","async function e(e){e.preventDefault();let t=e.target,n=t.querySelector(`.submit-btn`);n&&(n.textContent=`TRANSMITTING...`,n.disabled=!0);let r=document.getElementById(`fullName`).value,i=document.getElementById(`phoneNumber`).value,a=document.getElementById(`companyName`).value,o=document.getElementById(`businessEmail`).value,s=document.getElementById(`productCategory`).value,c=document.getElementById(`productName`).value,l=document.getElementById(`itemQuantity`).value,u=document.getElementById(`message`).value,d={fullName:r,phoneNumber:i,companyName:a,businessEmail:o,productCategory:s,productName:c,itemQuantity:l,message:u},f=`https://wa.me/+917975310662?text=${`*New Bulk Supply Inquiry*%0A%0A*Name:* ${r}%0A*Phone:* ${i}%0A*Company:* ${a}%0A*Email:* ${o}%0A*Category:* ${s}%0A*Product:* ${c}%0A*Quantity:* ${l}%0A*Message:* ${u}`}`;try{await Promise.all([fetch(`/api/enquiry`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(d)}),new Promise(e=>{window.open(f,`_blank`),e()})]),t.reset()}catch(e){console.error(`Error submitting form:`,e),alert(`Something went wrong submitting to the backend, but WhatsApp should have opened.`)}finally{n&&(n.textContent=`REQUEST A QUOTE`,n.disabled=!1)}}var t=document.getElementById(`inquiryForm`);t&&t.addEventListener(`submit`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Foundation.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`foundations-section`),t=document.querySelectorAll(`[data-tilt]`);if(!e)return;let n=new IntersectionObserver(t=>{t.forEach(t=>{t.isIntersecting&&(e.classList.add(`is-visible`),n.unobserve(t.target))})},{threshold:.15});n.observe(e),window.innerWidth>768&&t.forEach(e=>{let t=e;t.addEventListener(`mouseenter`,()=>{t.style.setProperty(`--delay`,`0s`)}),t.addEventListener(`mousemove`,e=>{let n=t.getBoundingClientRect(),r=e.clientX-n.left,i=e.clientY-n.top,a=n.width/2,o=n.height/2,s=(i-o)/o*-6,c=(r-a)/a*6;t.style.transform=`perspective(1000px) rotateX(${s}deg) rotateY(${c}deg) translateY(-8px) scale(1.02)`}),t.addEventListener(`mouseleave`,()=>{t.style.transform=`perspective(1000px) rotateX(0deg) rotateY(0deg) translateY(0) scale(1)`})})}e(),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Header.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.querySelector(`.dropdown-trigger`),t=document.querySelector(`.dropdown-container`);e&&t&&e.addEventListener(`click`,e=>{window.innerWidth<=1e3&&(e.preventDefault(),t.classList.toggle(`open`))})});"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/ContactUs/InquiryForm.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`inquiryForm`);if(!e)return;let t=e.querySelectorAll(`input, textarea`);t.forEach(e=>{e.addEventListener(`input`,()=>{if(e.checkValidity()){e.classList.remove(`invalid`);let t=e.parentElement?.querySelector(`label`);t&&t.classList.remove(`invalid-label`)}})}),e.addEventListener(`submit`,async n=>{n.preventDefault();let r=!0;if(t.forEach(e=>{let t=e.parentElement?.querySelector(`label`);e.checkValidity()?(e.classList.remove(`invalid`),t&&t.classList.remove(`invalid-label`)):(r=!1,e.classList.add(`invalid`),t&&t.classList.add(`invalid-label`))}),r){let t=e.querySelector(`.submit-btn`),n=t?.querySelector(`span`);n&&(n.textContent=`TRANSMITTING...`),t&&(t.disabled=!0);let r=document.getElementById(`name`).value,i=document.getElementById(`phone`).value,a=document.getElementById(`company`).value,o=document.getElementById(`email`).value,s=document.getElementById(`product_category`).value,c=document.getElementById(`product_name`).value,l=document.getElementById(`item_quantity`).value,u=document.getElementById(`message`).value,d={name:r,phone:i,company:a,email:o,product_category:s,product_name:c,item_quantity:l,message:u},f=`https://wa.me/+917975310662?text=${`*New Contact Inquiry*%0A%0A*Name:* ${r}%0A*Phone:* ${i}%0A*Company:* ${a}%0A*Email:* ${o}%0A*Category:* ${s}%0A*Product:* ${c}%0A*Quantity:* ${l}%0A*Message:* ${u}`}`;try{await Promise.all([fetch(`/api/enquiry`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(d)}),new Promise(e=>{window.open(f,`_blank`),e()})]),alert(`Message transmitted successfully!`),e.reset()}catch(e){console.error(`Error submitting form:`,e),alert(`Something went wrong submitting to the backend, but WhatsApp should have opened.`)}finally{n&&(n.textContent=`SUBMIT INQUIRY`),t&&(t.disabled=!1)}}})});"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Media/MediaHero.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`media-hero`),t=document.getElementById(`media-glow`);if(!e)return;t&&e.addEventListener(`mousemove`,n=>{let r=e.getBoundingClientRect();t.style.left=`${n.clientX-r.left}px`,t.style.top=`${n.clientY-r.top}px`});let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-visible`),n.unobserve(e.target))})},{threshold:.1});n.observe(e)}document.addEventListener(`DOMContentLoaded`,e),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Home/Mission.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`mission-section`),t=document.getElementById(`cursor-glow`),n=document.querySelectorAll(`[data-tilt]`);e&&t&&e.addEventListener(`mousemove`,n=>{let r=e.getBoundingClientRect(),i=n.clientX-r.left,a=n.clientY-r.top;t.style.left=`${i}px`,t.style.top=`${a}px`}),n.forEach(e=>{let t=e;t.addEventListener(`mousemove`,e=>{let n=t.getBoundingClientRect(),r=e.clientX-n.left,i=e.clientY-n.top,a=n.width/2,o=n.height/2,s=(i-o)/o*-4,c=(r-a)/a*4;t.style.transform=`perspective(1000px) rotateX(${s}deg) rotateY(${c}deg) scale3d(1.01, 1.01, 1.01)`}),t.addEventListener(`mouseleave`,()=>{t.style.transform=`perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)`})})});"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/Media/RecognitionCard.astro?astro&type=script&index=0&lang.ts","function e(){document.querySelectorAll(`[data-parallax-card]`).forEach(e=>{let t=e,n=t.querySelector(`.card-bg-image`),r=t.querySelector(`.card-content`),i=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-visible`),i.unobserve(e.target))})},{threshold:.15});i.observe(t),window.innerWidth>768&&(t.addEventListener(`mousemove`,e=>{let i=t.getBoundingClientRect(),a=e.clientX-i.left,o=e.clientY-i.top,s=i.width/2,c=i.height/2,l=(a-s)/18,u=(o-c)/18;r&&(r.style.transform=`translate(${l}px, ${u}px)`),n&&(n.style.transform=`scale(1.08) translate(${-l*.5}px, ${-u*.5}px)`)}),t.addEventListener(`mouseleave`,()=>{r&&(r.style.transform=`translate(0px, 0px)`),n&&(n.style.transform=`scale(1) translate(0px, 0px)`)}))})}document.addEventListener(`DOMContentLoaded`,e),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/category/[category]/[slug].astro?astro&type=script&index=0&lang.ts","function e(){document.querySelectorAll(`.schema-faq-question`).forEach(e=>{let t=e.cloneNode(!0);e.parentNode&&e.parentNode.replaceChild(t,e),t.addEventListener(`click`,()=>{let e=t.classList.contains(`is-open`);if(document.querySelectorAll(`.schema-faq-question.is-open`).forEach(e=>{e.classList.remove(`is-open`)}),document.querySelectorAll(`.schema-faq-answer.is-open`).forEach(e=>{e.classList.remove(`is-open`)}),!e){t.classList.add(`is-open`);let e=t.nextElementSibling;e&&e.classList.contains(`schema-faq-answer`)&&e.classList.add(`is-open`)}})});let e=document.querySelectorAll(`.wp-content details`);e.forEach(t=>{t.addEventListener(`toggle`,()=>{t.open&&e.forEach(e=>{e!==t&&e.open&&(e.open=!1)})})})}e(),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/pages/blog/[slug].astro?astro&type=script&index=0&lang.ts","function e(){document.querySelectorAll(`.schema-faq-question`).forEach(e=>{let t=e.cloneNode(!0);e.parentNode&&e.parentNode.replaceChild(t,e),t.addEventListener(`click`,()=>{t.classList.toggle(`is-open`);let e=t.nextElementSibling;e&&e.classList.contains(`schema-faq-answer`)&&e.classList.toggle(`is-open`)})})}e(),document.addEventListener(`astro:page-load`,e);"],["/Users/sujaykumar/Documents/GitHub/108medz/sakrt-website/src/components/About/about.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`about-section`),t=document.getElementById(`ambient-glow`),n=window.innerWidth<=768;e&&t&&e.addEventListener(`mousemove`,n=>{let r=e.getBoundingClientRect();t.style.left=`${n.clientX-r.left}px`,t.style.top=`${n.clientY-r.top}px`}),n||document.querySelectorAll(`[data-tilt]`).forEach(e=>{let t=e,n=t.querySelector(`.card-spotlight`);t.addEventListener(`mouseenter`,()=>{t.style.setProperty(`--delay`,`0s`)}),t.addEventListener(`mousemove`,e=>{let r=t.getBoundingClientRect(),i=e.clientX-r.left,a=e.clientY-r.top;n&&(n.style.left=`${i}px`,n.style.top=`${a}px`);let o=r.width/2,s=r.height/2,c=(a-s)/s*-2,l=(i-o)/o*2;t.style.transform=`perspective(1000px) rotateX(${c}deg) rotateY(${l}deg) translateY(-4px)`}),t.addEventListener(`mouseleave`,()=>{t.style.transform=``})});let r=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-visible`),r.unobserve(e.target))})},{threshold:.12});document.querySelectorAll(`.hero-header, .animate-card, .animate-section`).forEach(e=>r.observe(e));let i=document.getElementById(`about-products-toggle`),a=document.querySelectorAll(`.product-grid .product-card`),o=!1,s=()=>{a.forEach((e,t)=>{n&&!o&&t>=4?e.classList.add(`mobile-hidden`):e.classList.remove(`mobile-hidden`)}),i&&(i.style.display=n?`inline-flex`:`none`,i.innerHTML=o?`View Less <span class=\"arrow\">↑</span>`:`View More <span class=\"arrow\">↓</span>`)};s(),i&&i.addEventListener(`click`,()=>{o=!o,s()});let c=document.getElementById(`about-text-toggle`),l=document.querySelector(`.about-text-more`),u=!1,d=()=>{n&&!u?l?.classList.add(`mobile-hidden`):l?.classList.remove(`mobile-hidden`),c&&(c.style.display=n?`inline-flex`:`none`,c.innerHTML=u?`View Less <span class=\"arrow\">↑</span>`:`View More <span class=\"arrow\">↓</span>`)};d(),c&&c.addEventListener(`click`,()=>{u=!u,d()})}document.addEventListener(`DOMContentLoaded`,e),document.addEventListener(`astro:page-load`,e);"]],"assets":["/favicon.ico","/favicon.svg","/robots.txt","/_astro/Hero.astro_astro_type_script_index_0_lang.auXYiWtI.js","/about/imgi_10_supply-chain.png","/about/imgi_4_biodegradable_carry_bags-biodegradable_bags__compostable-products-ecofriendly-bags.-1.webp","/about/imgi_5_biodegradable_carry_bags_biodegradable_bags-compostable-products-ecofriendly-bags.webp","/about/imgi_6_biodegradable_carry_bags-biodegradable_bags_compostable-products-ecofriendly-bags.webp","/about/imgi_7_biodegradable_carry_bags-biodegradable_bags-compostable-products-ecofriendly_bags.webp","/about/imgi_8_Biodegradable_carry_bags-biodegradable_bags-compostable-products-ecofriendly-bags.webp","/about/imgi_9_server-check.png","/certificates/CIPET.webp","/certificates/CPCB.pdf","/certificates/ISO.webp","/certificates/global.pdf","/compostable-bags/WhatsApp Unknown 2026-08-07 at 10.21.47 AM.zip","/compostable-bags/imgi_10_biodegradable-bags-compostable-products-ecofriendly-bags-1-2.webp","/compostable-bags/imgi_11_courier-bags.webp","/compostable-bags/imgi_12_biodegradable-bags-compostable-products-eco-products-3.webp","/compostable-bags/imgi_4_biodegradable-bags-compostable-products-ecofriendly-bags-1-1.webp","/compostable-bags/imgi_5_compostable-table-wares-Biodegradable-bag-biodegradable-bag-carry-bags-2.webp","/compostable-bags/imgi_6_biodegradable-bags-compostable-products-eco-product.-3.webp","/compostable-bags/imgi_7_Compostable-grow-bags-e1780576071172.webp","/compostable-bags/imgi_8_biodegradable-bags-compostable-products-ecofriendly-bags-1-3.webp","/compostable-bags/imgi_9_biodegradable-bags-compostable-products-ecofriendly-bags-2-1.webp","/compostable-films/imgi_4_compostable-strecth-films.webp","/compostable-films/imgi_5_biodegradable-bags-compostable-products-ecofriendly-bags-1.webp","/compostable-films/imgi_6_Shirnk-films.webp","/hero/imgi_4_biodegradable-carry-bags-biodegradable-bags-compostable-products-ecofriendly-bags.webp","/hero/imgi_5_biodegradable-bags-compostable-products-ecofriendly-bags.webp","/hero/imgi_6_biodegradable-bags-compostable-products-ecofriendly-bags-carry-bags-.webp","/hero/imgi_7_biodegradable-bags-compostable-products-ecofriendly-bags-.webp","/logo/footer-logo.webp","/logo/sakrtlogo.png","/media/event-win.jpg","/media/sustainable.png","/media/world-env-day.webp","/products-icon/imgi_5_product.png","/products-icon/imgi_6_order.png","/products-icon/imgi_7_bag.png","/products-icon/imgi_8_exchange.png","/tableware/drinking-straws.jpg","/tableware/imgi_10_biodegradable-bags-compostable-products-eco-product.-2.webp","/tableware/imgi_11_biodegradable-bags-compostable-products-ecofriendly-bags-2.webp","/tableware/imgi_12_biodegradable-bags-compostable-products-eco-product-1.webp","/tableware/imgi_13_biodegradable-bags-compostable-products-eco-products-1.webp","/tableware/imgi_4_biodegradable-bags-compostable-products-eco-product-1-2.webp","/tableware/imgi_5_biodegradable-bags-compostable-products-eco-products.webp","/tableware/imgi_6_biodegradable-bags-compostable-products-eco-product.webp","/tableware/imgi_7_biodegradable-bags-compostable-products-eco-product.-1.webp","/tableware/imgi_9_biodegradable-bags-compostable-products-eco-product-2-1.webp","/_astro/biodegradable_greybags.DzRDEfuK.png","/_astro/Layout.B5dwR-gy.css","/_astro/_slug_.C3kN5D9_.css","/_astro/_category_.Bj2_U2Bf.css","/_astro/_slug_.B8qOWB5G.css","/_astro/CIPET.BSs5GUHo.webp","/_astro/bio-compliance.C2iAaPwG.png","/_astro/iso.mGwTLu9P.png","/_astro/cpcb.XyG4ILEq.png","/_astro/agriculture_biodegradable_bags.C9YBO0cO.png","/_astro/biodegradable_water.CSvgFoYZ.png","/_astro/index.DVvcf-HZ.css","/_astro/index.DX8m2YTr.css","/_astro/index.B-VnIfF_.css","/_astro/index.sO1LLjiA.css","/_astro/index.BCUfuMVB.css","/_astro/index.UfiF2PzJ.css","/_astro/index.Ivpvoqw8.css","/_astro/planet.CqECmt5X.png","/_astro/sakrt_bag.CKeDLXdL.png","/_astro/plants and trees.B5F0TNbp.png","/_astro/biodegradable_utensils.FhJ4E4dO.png","/_astro/plastic courier bag.BMtbeT3t.webp","/_astro/Sakrt Plant-Based PLA Straws.DmRiDP43.png","/_astro/index.I7dOifJl.css","/_astro/index.CF2MhEUD.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"zOjvSEb19p9VMrIiUiLX09yox4PJP0PrTXp11uRhVQs=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "1792c0fd-5327-4b2f-a4f2-383911cebd5c") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
